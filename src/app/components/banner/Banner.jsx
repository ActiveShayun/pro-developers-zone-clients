...
const Banner = () => {
    return (
        <div>
            <div className='flex lg:justify-center mb-4 lg:mb-11'>
                <div className='bg-radial-[at_40%_50%] from-black to-100% 
                 to-[#2CCEBA]/60 text-center py-3 px-3 rounded-full border border-[#2CCEBA]'>
                   ...
                   '>
                        <GradientStar />
                        Smarter Idea, instant soluations
                    </p>
                </div>
            </div>
            {/* title */}
            <div className='lg:mb-[108px] mb-16 '>
                <Title
                    firstLineText={'We are your Software'}
                    secondLineTextOne={'Development'}
                    secondLineTextTwo={'Team'}
                    lastLineText={'in The Cloud'}
                />
                <div className='flex lg:justify-center mt-4 lg:mt-8'>
